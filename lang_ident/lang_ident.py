...
subprocess.call(['ffmpeg','-y', '-i', '../videos/video.mp4', '-vn', '-ar', '48000', '-ac', '1', '-ab', '192k', '-f', 'wav', '../audio/output.wav'])
...
subprocess.call( ['ffmpeg','-y', '-i', '../audio/output.wav', '-ss', start_time, '-t', duration, '../audio/output_cut.wav'])
...
if __name__ == '__main__':
    ...
    sr, audio = wav_read('../audio/output_cut.wav')
    ...
    os.system('touch ../videos/language.txt')
    os.system('echo '+language+' > ../videos/language.txt')
